...
The \textcolor{blue}{iris} dataset provides the measurements in centimeters of the variables sepal length and width, and petal length and width, for 50 flowers from each of three species of iris. The species are __Iris setosa__, __Iris versicolor__, and __Iris virginica__.
